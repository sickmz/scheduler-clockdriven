...
/* Il tempo di esecuzione del task aperiodico (in quanti temporali da 10ms) */
extern int AP_WCET;

/* Inizializzazione delle strutture dati P_TASKS[], AP_TASK, SCHEDULE[], SLACK e AP_WCET */
void task_init();

/* Finalizzazione delle strutture dati */
void task_destroy();

/* Richiede il rilascio del task aperiodico e ritorna il numero di frame
   necessari per completarne l'esecuzione.
*/
